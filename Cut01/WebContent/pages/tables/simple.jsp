...
<html>
	<head>
		...
		<title>SUNLIT | Simple Tables</title>
...
-->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="../../FactoryIndex3.jsp" class="brand-link">
...
-->
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../tables/simple.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Simple Tables</p>
                </a>
              </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020- <a href="http://adminlte.io">SUNLIT.ind.co.,jsp.</a></strong>
  </footer>
