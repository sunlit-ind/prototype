...
<html>
	<head>
		...
		<title>SUNLIT | General Form Elements</title>
...
-->
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../forms/general.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020- <a href="http://sunlit-ind.co.jp/">SUNLIT.ind.co.,ind.</a></strong>
  </footer>
