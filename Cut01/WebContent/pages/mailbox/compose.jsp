...
<html>
	<head>
		...
		<title>SUNLIT | Compose Message</title>
...
-->
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../mailbox/compose.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Compose</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-3">
            <a href="mailbox.jsp" class="btn btn-primary btn-block mb-3">Back to Inbox</a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020- <a href="http://adminlte.io">SUNLIT.ind.co.,ltd</a>.</strong>
  </footer>
